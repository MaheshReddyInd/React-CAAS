...
export default function EduKarnatakaSidebar() {
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              <li className="items-center">
                <Link
                  className={
                    ...
                    (window.location.href.indexOf("/Onboarding/EduKarnatakaDashboard") !== -1
              ...
              <li className="items-center">
                <Link
                  className={
                    ...
                    (window.location.href.indexOf("/Onboarding/InstitutionOnboarding") !== -1
                      ? "text-lightBlue-500 hover:text-lightBlue-600"
                      : "text-blueGray-700 hover:text-blueGray-500")
                  }
                  to="/Onboarding/InstitutionOnboarding"
                >
                  <i
                    className={
              ...
              <li className="items-center">
                <Link
                  className={
                    "text-xs py-3 font-bold block " +
                    (window.location.href.indexOf("/Onboarding/StaffOnboarding") !== -1
                      ? "text-lightBlue-500 hover:text-lightBlue-600"
                      : "text-blueGray-700 hover:text-blueGray-500")
                  }
                  to="/Onboarding/StaffOnboarding"
                >
                  <i
                    className={
              ...
              <li className="items-center">
                <Link
                  className={
                    "text-xs py-3 font-bold block " +
                    (window.location.href.indexOf("/Onboarding/StudentOnboarding") !== -1
                      ? "text-lightBlue-500 hover:text-lightBlue-600"
                      : "text-blueGray-700 hover:text-blueGray-500")
                  }
